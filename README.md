...
If you want more information about connection establishment, you can give a look to the [Server](https://github.com/MarioCela/Eriantys_Board_Game_SE/blob/main/src/main/java/it/polimi/ingsw/Server.java) class.
...
Given that I personally implemented the CLI, I will focus on that.

First of all, to offer a better game experience, we introduce commands that allow the player to get information about the current status of the game, in all its components.
